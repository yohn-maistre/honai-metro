...
- ⏭️ NEXT: P3 (explore hub + act-1 atlas map port per amendment 4 — read detak's index.astro act 1 island component FIRST + guest-home redirect), then P4-P8 per plan above.
