import { default as i18n, type Config, type Parser } from 'sveltekit-i18n'
...
const config: Config = {
  loaders: [
    ...
    // { locale: 'et', key: '', loader: async () => (await import('./et.json')).default },
    // { locale: 'fi', key: '', loader: async () => (await import('./fi.json')).default },
    ...
    // { locale: 'pt-BR', key: '', loader: async () => (await import('./pt-BR.json')).default },
...
export const aliases = new Map([
  // ETNOS: Indonesian aliases
  ['id-ID', 'id'],
  ['in', 'id'],
  // upstream aliases (kept for future re-enabling)
  ['zh-CN', 'zh-Hans'],
  ['zh-TW', 'zh-Hant'],
  ['en-US', 'en'],
  ['en-GB', 'en'],
